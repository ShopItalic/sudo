...
@REM 校验DFU标志字符串的格式
set HARDWARE_BATH_VALID="#define HARDWARE_1171_ENABLED"
...
@REM 判断宏定义值是否等于字符串 "1"
if "%check%"=="1" (
    echo HARDWARE_1171_ENABLED is defined as 1
) else (
    echo HARDWARE_1171_ENABLED is not defined as 1
    echo %check%
    exit
)
...
@REM 软件版本字符串的格式
set SOFTWARE_VERSION="#define RING_1171_SOFTWARE_VERSION"

@REM 硬件版本字符串的格式
set HARDWARE_VERSION="#define RING_1171_HARDWARE_VERSION"
