...
//    GH3X2X_DEBUG_LOG_PARAM("RecordTiaGainInfo slot0: rx0 = %d, rx1 = %d, rx2 = %d, rx3 = %d\r\n" ,g_pstGh3x2xAgcInfo->uchTiaGainRecord[0],g_pstGh3x2xAgcInfo->uchTiaGainRecord[1],g_pstGh3x2xAgcInfo->uchTiaGainRecord[2],g_pstGh3x2xAgcInfo->uchTiaGainRecord[3]);    
//    GH3X2X_DEBUG_LOG_PARAM("uchDrvCurrentRecord slot0: drv = %d\r\n" ,g_pstGh3x2xAgcInfo->uchDrvCurrentRecord[0]);    
}
