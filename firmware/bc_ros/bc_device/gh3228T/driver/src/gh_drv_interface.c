...
#define am_bsp_i2c_write_REG_BUFFER_LEN        (4)     /**< i2c write reg buffer len */
...
{
    GU8 uchBuffArr[am_bsp_i2c_write_REG_BUFFER_LEN] = {0};
    ...
    g_pI2cWriteFunc(g_puchI2cDeviceIdList[g_uchGh3x2xChipOperateIndexRealtime], uchBuffArr, am_bsp_i2c_write_REG_BUFFER_LEN);
}
