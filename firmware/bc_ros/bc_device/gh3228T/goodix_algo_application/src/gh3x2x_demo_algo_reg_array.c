...
#elif (defined HARD_VERSION_541) || (defined HARD_VERSION_561) || (defined HARD_VERSION_581)
    {0x33C0, 0x0000}, {0x33C2, 0x0000}, {0x33C4, 0x0000}, {0x33C6, 0x0000}, {0x33C8, 0x0000}, {0x33CA, 0x0000},
...
//    {0x42CC, 0x0001}, {0x42CE, 0x0000}, {0x42D0, 0x0000}, {0x42D2, 0x0000}, {0x42D4, 0x001E}, {0x42D6, 0x0000},
//    {0x42D8, 0x000F}, {0x42DA, 0x0000}, {0x42DC, 0x0004}, {0x42DE, 0x0000}, {0x42E0, 0x0003}, {0x42E2, 0x0000},
//    {0x42E4, 0x0000}, {0x42E6, 0x0000}, {0x42E8, 0x0000}, {0x42EA, 0x0000}, {0x44C0, 0x0001}, {0x44CC, 0xFF00},
//    {0x44D4, 0xFF01}, {0xFFFF, 0x0001}
...
{0x33C0, 0x0000}, {0x33C2, 0x0000}, {0x33C4, 0x0000}, {0x33C6, 0x0000}, {0x33C8, 0x0000}, {0x33CA, 0x0000},
    ...
    {0x42E8, 0x0000}, {0x42EA, 0x0000}, {0x44C0, 0x0001}, {0x44CC, 0xFF00}, {0x44D4, 0xFF01}, {0xFFFF, 0x0001}
...
//    {0x42E8, 0x0000}, {0x42EA, 0x0000}, {0x44C0, 0x0001}, {0x44CC, 0xFF01}, {0x44D4, 0xFF00}, {0xFFFF, 0x0001}     
 ...
 {0x33C0, 0x0000}, {0x33C2, 0x0000}, {0x33C4, 0x0000}, {0x33C6, 0x0000}, {0x33C8, 0x0000}, {0x33CA, 0x0000},
    ...
    {0x42DC, 0x0004}, {0x42DE, 0x0000}, {0x42E0, 0x0003}, {0x42E2, 0x0000}, {0x42E4, 0x0000}, {0x42E6, 0x0000},
    {0x42E8, 0x0000}, {0x42EA, 0x0000}, {0x44C0, 0x0001}, {0x44CC, 0xFF01}, {0x44D4, 0xFF00}, {0xFFFF, 0x0001}
#elif ( defined(HANDWARE_1_18_1) || defined(HANDWARE_1_19_1))
...
{
#if (defined HARD_VERSION_522) || (defined HARD_VERSION_523) || (defined HARD_VERSION_541) || (defined HARD_VERSION_551) || (defined HARD_VERSION_561) || (defined HARD_VERSION_581) || (defined HARD_VERSION_571)
    {0xFFFF, 0x0001}
#elif ( defined(HANDWARE_1_14_1))	  
//100hz
//   {0x33C0, 0x0000}, {0x33C2, 0x0000}, {0x33C4, 0x0000}, {0x33C6, 0x0000}, {0x33C8, 0x0000}, {0x33CA, 0x0000},
