...
//typedef void (*ppg_g_sensor_data_timer_start_callback)(void);
//typedef void (*ppg_g_sensor_data_timer_stop_callback)(void);
//typedef void (*ppg_g_sensor_data_read_callback)(uint8_t *data_buff,uint16_t *data_count);

struct gh3026_g_sensor_struct
{
