...
#define DEVICE_GH3X2X_ID            (0x14)
#define DEVICE_GH3X2X_WRITE_ID      (DEVICE_GH3X2X_ID << 1)
#define DEVICE_GH3X2X_READ_ID       (DEVICE_GH3X2X_WRITE_ID + 1)
...
#endif
#define __GS_SENSITIVITY_CONFIG__           (GSENSOR_SENSITIVITY_2048_COUNTS_PER_G)  /**< gsensor sensitivity config */
#define __GS_GYRO_ENABLE__                  (0)        /*Gyro enable*/
#define __GS_NONSYNC_READ_EN__              (1)
#if __GS_NONSYNC_READ_EN__
#define __GS_SAMPLE_RATE_HZ__               (25.0)        /*gsenor sample rate(Hz)*/
#define __GS_READ_POINT_NUM__               (10)         /* host read gsensor sample num in one time */
...
#define __SUPPORT_HARD_RESET_CONFIG__       (0)         /**< support hard reset config */
...
#define __GH3X2X_PROTOCOL_SEND_TIMER_PERIOD__           (30)        /** (unit : ms ) protocal data send timer period */
...
/*config list*/
#define __GH3X2X_CFG_LIST_MAX_NUM__                     (4)         /**< max num of config list(1 ~ 8) */
...
/*fifo monitor*/
#define GH3X2X_FIFO_MONITOR_EN                  (0)
