...
#define GOODIX_PLATFORM_SPI_READ_ENTITY()
#define GOODIX_PLATFORM_SPI_CS_CTRL_ENTITY()
#define GOODIX_PLATFORM_SPI_RESET_PIN_ENTITY()
...
#define GOODIX_PLATFORM_INT_GET_GS_DATA_ENTITY()
#define GOODIX_PLATFORM_LOG_ENTITY()
#define GOODIX_PLATFORM_DELAY_US_ENTITY()
#define GOODIX_PLATFORM_DELAY_MS_ENTITY()
#define GOODIX_PLATFORM_DELAY_MS_ENTITY()
#define GOODIX_PLATFORM_SERIAL_SEND_ENTITY()
...
#define GOODIX_PLATFORM_INT_GET_CAP_DATA_ENTITY()
#define GOODIX_PLATFORM_INT_TEMP_START_CACHE_ENTITY()
#define GOODIX_PLATFORM_INT_TEMP_STOP_CACHE_ENTITY()
#define GOODIX_PLATFORM_INT_GET_TEMP_DATA_ENTITY()
#define GOODIX_PLATFORM_WRITE_CAP_TO_FLASH_ENTITY()
#define GOODIX_PLATFORM_READ_CAP_FROM_FLASH_ENTITY()
...
#define GOODIX_PLATFORM_PRESSURE_PARAS_READ_ENTITY()    
#define GOODIX_PLATFORM_PRESSURE_PARAS_WRITE_ENTITY()   
#define GOODIX_PLATFORM_PRINTF_ENTITY()
#define GOODIX_PLATFORM_MALLOC_USER_ENTITY()
#define GOODIX_PLATFORM_FREE_USER_ENTITY()
...
extern uint8_t Gh3x2x_get_wearFlag(void);
extern void Gh3x2x_get_grayCard(uint32_t *pdata);
