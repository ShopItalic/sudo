...
//       printf("jjjjjjjjjjjjjjjjjjjjjj   %d %d %d %d %d  \r\n", ii, hr_gr_high_buffer[0], hr_gr_high_buffer[1], hr_gr_high_buffer[2], hr_gr_high_buffer[3]);
    ...
    GrayCardBuf[0] = hr_gr_final;
    GrayCardBuf[1] = spo2_red_final;
    GrayCardBuf[2] = spo2_ir_final;
    GrayCardBuf[3] = green_high_final;
    GrayCardBuf[4] = single_gr_led_judge;
...
void get_GrayCardBuf(uint32_t *pdata)
{
...
bool hx3605_gary_card_callback_register(void *function_callback)
{
