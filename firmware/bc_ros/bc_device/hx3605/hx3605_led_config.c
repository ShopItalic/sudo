...
void hx3605_ledon_init(uint8_t led_select) //led_select : 1,2,4 - ldr0,led1,led2
{
    ...
    uint8_t ps0_osr = 0;    /* 0 = 128 ; 1 = 256 ; 2 = 512 ; 3 = 1024 */
...
//    uint16_t thres_level =0;
    ...
    uint8_t ldrsel_ps0 =led_select;      //ps0 LDR SELECT 01:ldr0-IR 02:ldr1-RLED  04:ldr2-GLED
    /***********cap *********/
    ...
    uint8_t led_on_time  = 8;      /* 0 = 32clk2=8us ; 8 = 64clk=16us; 16=128clk=32us ; 32 = 256clk=64us ;
