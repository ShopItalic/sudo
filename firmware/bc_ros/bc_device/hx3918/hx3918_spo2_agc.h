#ifndef _HX3918_SPO2_AGC_H_
#define _HX3918_SPO2_AGC_H_
#include <stdint.h>
#include <stdbool.h>
#include "hx3918.h"
...
#define SPO2_CAL_INIT_LED_GREEN 8
#define SPO2_CAL_INIT_LED_RED 16
#define SPO2_CAL_INIT_LED_IR 8
...
void hx3918_spo2_cal_init(void);
void hx3918_spo2_cal_off(void);

void read_spo2_data_packet(int32_t *buf);
void read_spo2_ir_packet(int32_t *buf);
void hx3918_spo2_read_data(int32_t *buf);

void hx3918_spo2_low_power(void);
void hx3918_spo2_normal_power(void);
...
uint8_t hx3918_spo2_read_data_packet(int32_t *s_buf);
