...
typedef int (*ST25DV_Write_Func)(uint16_t, uint16_t, const uint8_t*, uint16_t);
typedef int (*ST25DV_Read_Func) (uint16_t, uint16_t, uint8_t*, uint16_t);
typedef int (*ST25DV_IsReady_Func) (uint16_t, const uint32_t);
...
#define I_AM_ST25DV04_1                        0x24
#define I_AM_ST25DV04_2                        0x50
