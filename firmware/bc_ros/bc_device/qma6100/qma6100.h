...
extern int32_t qma6100_writereg(uint8_t reg_add,uint8_t reg_dat);
extern int32_t qma6100_readreg(uint8_t reg_add,uint8_t *buf,uint16_t num);
extern uint8_t qma6100_chip_id(void);
extern int32_t qma6100_init(uint32_t odr_config);
extern int32_t qma6100_initialize(enum qma6100_odr odr_config);
extern int32_t qma6100_set_range(unsigned char range);
extern int32_t qma6100_set_mode_odr(int32_t mode, int32_t mclk, int32_t div, int32_t lpf);
extern int32_t qma6100_read_raw_xyz(int32_t *data);
extern int32_t qma6100_read_acc_xyz(int32_t *accData);
#if defined(QMA6100_DATA_READY)
extern void qma6100_drdy_config(int32_t int_map, int32_t enable);
#endif
#if defined(QMA6100_FIFO_FUNC)
extern void qma6100_fifo_config(int32_t int_map, int32_t enable);
extern int32_t qma6100_read_fifo(uint8_t *fifo_buf);
extern void qma6100_exe_fifo(uint8_t *fifo_buf);
extern uint8_t* qma6100_get_fifo(void);
#endif

#if defined(QMA6100_STEPCOUNTER)
extern uint32_t qma6100_read_stepcounter(void);
extern void qma6100_stepcounter_config(int32_t enable);
extern void qma6100_clear_step(void);
#if defined(QMA6100_STEP_INT)
extern void qma6100_step_int_config(int32_t int_map, int32_t enable);
#endif
#if defined(QMA6100_SIGNIFICANT_STEP_INT)
extern void qma6100_sigstep_int_config(int32_t int_map, int32_t enable);
#endif
#endif

#if defined(QMA6100_ANY_MOTION)
extern void qma6100_anymotion_config(int32_t int_map, int32_t enable);
#endif
#if defined(QMA6100_NO_MOTION)
extern void qma6100_nomotion_config(int32_t int_map, int32_t enable);
#endif

extern void qma6100_irq_hdlr(void);

extern void qma6100_standby_on(void);
extern void qma6100_standby_off(void);
