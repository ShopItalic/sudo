...
static struct BSP_I2C bsp_list =   
{
	  ...
	  .i2c_config = {
						  ...
						  .i2c_io_sda_pin = NRF_GPIO_PIN_MAP(0,1),
						  ...
						  .i2c_io_scl_pin = NRF_GPIO_PIN_MAP(0,6),
						  .i2c_io_sda_pin = NRF_GPIO_PIN_MAP(0,8),
#elif defined(HANDWARE_1_17_1)

						  .i2c_io_scl_pin = NRF_GPIO_PIN_MAP(1,06),
						  .i2c_io_sda_pin = NRF_GPIO_PIN_MAP(1,12),		      
 ...
 * Return            : 
 *******************************************************************************/
static uint8_t bsp_i2c_writeregs(uint8_t slave, uint8_t reg_add,uint8_t *reg_data,uint8_t length,struct simulation_i2c_config const *bsp_i2c)
{
	bsp_i2c_start(bsp_i2c);
	bsp_i2c_write_byte(slave,bsp_i2c);
	if(bsp_i2c_wait_ack(bsp_i2c)){
 ...
 * Return            : 
 *******************************************************************************/
static void bsp_simulation_i2c3_register(void)
{
...
device_initcall(bsp_simulation_i2c3_register);
