...
static void spi_1_event_callback_handler(nrf_drv_spi_evt_t const * p_event,void * p_context);
...
static struct BSP_SPI bsp_list =   
{
	  ...
	  .spi_config = {
					  ...
					  .cs_io_pin = NRF_GPIO_PIN_MAP(1,04),
					  .miso_io_pin = NRF_GPIO_PIN_MAP(0,18),
					  .mosi_io_pin = NRF_GPIO_PIN_MAP(0,21),
					  .sclk_io_pin = NRF_GPIO_PIN_MAP(0,14),	
		        ...
		        .spi_handler = NRFX_SPIM_INSTANCE(1),
		              ...
		              .spi_callback_handler = spi_1_event_callback_handler,
	                },
	  .spi_mutex_lock = {0},
	  .dev = {0},
};
...
//  Q_DEVICE_LOG_INFO("spi timeout llll \r\n");
//  q_device_delay_ms(2000);
//  return true;
	  //启动数据传输
  //Q_DEVICE_LOG_HEX("spi1 send:",spim_xfer.p_tx_buffer,spim_xfer.tx_length);
