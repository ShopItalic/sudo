...
/* P07 retains the P04/P05 actions: 0 disabled, 1 hold/release PTT, 2 tap recording toggle.
...
enum factory_swipe { FACTORY_SWIPE_UP, FACTORY_SWIPE_DOWN, FACTORY_SWIPE_LEFT, FACTORY_SWIPE_RIGHT };
bool app_factory_controls_swipe_enabled(unsigned direction); /* P09 Bluetooth scrolling defaults off */
