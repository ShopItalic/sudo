...
static void reset(void) {
    ...
    starts = stops = button_events = notifications = 0;
...
int main(void) {
    ...
    fprintf(stdout, "PASS P05: %u checks; actual IQS + factory recorder/file guards; double tap disabled, 60-second hold, release, faults, handoff, serialized upload; P01 race reproduced as control\n", checks);
    return 0;
}
