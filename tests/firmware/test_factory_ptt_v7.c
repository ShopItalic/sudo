...
int main(void) {
    ...
    report(0,0,0,true); CHECK(stops==1);
    fprintf(stdout, "PASS P07: %u checks; actual IQS + factory recorder/file guards; double tap disabled, 60-second hold, release, faults, handoff, serialized upload; P01 race reproduced as control\n", checks);
    return 0;
}
