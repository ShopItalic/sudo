"""Exercise P07 with the actual IQS driver, recorder lifecycle and shared file guards."""
...
from prepare_factory_ptt_v7 import IQS, APP, QUEUE, OVERLAY, PATCHES, patch_iqs, patch_touch, patch_ble, patch_queue
...
class FactoryPTTV7(unittest.TestCase):
    def test_generated_integration(self):
        with tempfile.TemporaryDirectory(prefix='factory-ptt-p07-') as folder:
            out = Path(folder)
